# movie listings, forcked off of angularjs-webpack-starter
...
The goal of this repository is to demonstrate a modern frontend setup for
[AngularJS](https://github.com/angular/angular.js) projects, in such a way that
it gets closer to how things are done with Angular. This project is using
[NPM](https://github.com/npm/npm) as package manager,
...
Once the repository has been cloned locally, you can use the following CLI
commands:
